...
* **Etapa de Predicción:** Se estimó el valor futuro de la distancia frontal restando el avance calculado por los encoders al estado anterior. Matemáticamente, se basa en la actualización del estado: $\hat{d}_{k}^{-} = \hat{d}_{k-1} - \Delta d_{k}$
